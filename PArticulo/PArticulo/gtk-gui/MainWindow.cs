...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='removeAction' action='removeAction'/><toolitem name='refreshAction' action='refreshAction'/><toolitem name='clearAction' action='clearAction'/><toolitem name='editAction' action='editAction'/><toolitem name='addAction' action='addAction'/></toolbar></ui>");
